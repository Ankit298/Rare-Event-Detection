...
train_metadata = train_metadata[0:undersamp_cutoff] #Undersampling
...
#Weighted Loss Function (beta1 = 0.7, beta2 = 0.3)
def loss(y_true,y_pred):
  cost = (1/32)*(0.7*(K.sum(y_true - y_pred))+0.3*K.sum((y_true-y_pred)**2))
  return cost
